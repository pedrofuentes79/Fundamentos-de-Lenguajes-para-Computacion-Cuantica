...
\section{Algoritmo en cálculo lambda-S}


%Dejo esto acá porque lo leí del paper y puede ser útil para escribir el algoritmo%
A Hadamard gate can be implemented by
\[
H = \lambda x : \mathbb{B}.\; x \; ?\; \ket{-} \; :\; \ket{+},
\]
where
\[
...
Therefore \( H : \mathbb{B} \Rightarrow S\mathbb{B} \), and we have
\[

...
El operador de Alice sobre w (el par de EPR) es:
\[
...
Finalmente, definimos el término completo que toma dos bits clásicos (de tipo $\mathbb{B} = \one \oplus \one$) y produce el estado final medido.
...
Analizamos la reducción de $\text{Condensacion} \ \one \ \one$. Vamos "desde adentro hacia afuera".
